  ...
  return (
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      .gate-form input:focus { box-shadow: var(--neu-in), 0 0 0 3px rgba(255,197,61,0.22); }
      ...
      .picker-field:focus-within { box-shadow: var(--neu-in-sm), 0 0 0 3px rgba(255,197,61,0.2); }
      ...
      .btn-amber {
        ...
        color: #201400; border-color: transparent; font-weight: 800;
        box-shadow: 6px 6px 14px rgba(0,0,0,0.35), -6px -6px 14px rgba(255,255,255,0.04), 0 0 0 1px rgba(255,197,61,0.25);
      }
      [data-theme="light"] .btn-amber { color: #2a1800; box-shadow: 6px 6px 14px rgba(163,177,198,0.5), -6px -6px 14px rgba(255,255,255,0.9), 0 0 0 1px rgba(201,123,0,0.15); }
